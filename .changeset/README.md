...
- Create PR from `feat/my-feature` → `main`
...
- This PR contains:
  - Updated `package.json` version (e.g., `1.0.3` → `1.0.4`)
...
- After merge, the workflow automatically:
  - Creates a git tag with the new version (e.g., `v1.0.4`)
  - Creates a GitHub Release with CHANGELOG for that version
