            ...
            <>
              <div className="relative flex h-full">
                <Popover.Button
                  ...
                  className="relative h-full flex items-center transition-all ease-out duration-200 focus:outline-none hover:text-ui-fg-base text-white text-sm md:text-base"
                >
                  Menu
                </Popover.Button>
              </div>
              ...
              >
                <PopoverPanel className="flex flex-col absolute w-full pr-4 sm:pr-0 sm:w-1/3 2xl:w-1/4 sm:min-w-min h-[calc(100vh-1rem)] z-30 inset-x-0 text-sm text-ui-fg-on-color m-2 backdrop-blur-2xl">
                  ...
                  >
                    ...
                    <ul className="flex flex-col gap-3 items-start justify-center flex-1">
