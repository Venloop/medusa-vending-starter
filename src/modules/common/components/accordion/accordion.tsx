...
const Item: React.FC<AccordionItemProps> = ({
  ...
  const classNames = {
    large: "text-ui-fg-subtle text-base",
    medium: "text-ui-fg-subtle text-sm",
    small: "text-ui-fg-subtle text-sm",
  }
  return (
        ...
        <div className="flex flex-col">
          <div className="flex w-full items-center justify-between">
            <div className="flex items-center gap-4">
              <Heading level="h2" className={classNames[headingSize]}>{title}</Heading>
            </div>
