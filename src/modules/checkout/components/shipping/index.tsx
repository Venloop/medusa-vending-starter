...
import IconEdit from "@modules/common/icons/edit"
          ...
          Promise.allSettled(promises).then((res) => {
            ...
            res
              ...
              .forEach((p) => 
                {
                  console.log("p", p)
                  pricesMap[p.value?.id || ""] = parseFloat(p.value?.amount!)
                }
              )
      ...
      <div className="flex flex-row items-center justify-between mb-6">
        ...
        >
          ...
          {!isOpen && (cart.shipping_methods?.length ?? 0) > 0 && (
            <CheckCircleSolid style={{ color: "#279D20" }} />
          )}
        </Heading>
        {!isOpen &&
                ...
                {hasPickupOptions && (
                  ...
                  >
                    <Radio
                      ...
                      className={clx(
                        "flex items-center justify-between text-small-regular cursor-pointer py-4 border rounded-rounded px-8 mb-2 hover:shadow-[0_0_0_4px_rgba(17,24,39,0.1)]",
                        {
